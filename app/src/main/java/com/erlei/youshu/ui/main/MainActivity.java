...
public class MainActivity extends BaseActivity
    ...
    protected void initView(View rootView) {
        ...
        getSupportFragmentManager().beginTransaction().add(R.id.content_main, ApiTestFragment.newInstance(), ApiTestFragment.class.getName()).commitNow();
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.content_main, ApiTestFragment.newInstance()).commitNow();
        }
